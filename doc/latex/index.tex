...
{\bfseries{Time complexity\+:}} K\texorpdfstring{$\ast$}{*}1440 comparisons + at max 1440 comparisons in find\+\_\+if applied on frequencies ~\newline
 = O(1) ~\newline
 {\itshape {\bfseries{Note}}} -\/ Here is K \texorpdfstring{$>$}{>} 0 is some constant representing no of comparisons per iteration, see \doxylink{class_time_intervals_ab0db3b45e15d8de01ad05e637254db3b}{Time\+Intervals\+::find\+Max\+Interval\+And\+Count} for more details ~\newline
